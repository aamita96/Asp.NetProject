...
<link href="templatemo_style.css" rel="stylesheet" type="text/css" />
	...
	<div id="templatemo_banner">
       	<div id="templatemo_banner_text">
            ...
            <p>
MUSIC WALA website gives them free access to the latest and unlimited music.
They can listen every type of music which they want to hear, from classical music to trending trans music.
They all need to do is to register it on the website and have to create an account and that’s all then they are free to enjoy the music according to their mood.
            </p>
    ...
    <a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
        ...
        <div id="templatemo_right_column">
        	<div id="new_released_section">
                ...
                <p style="text-align:left;font-family:Arial;font-size: 10pt;font-weight: bold;">Office:<br/>
                    MuSicW@la media Pvt Ltd Rajasthan(Jaipur) &nbsp;&nbsp;&nbsp;&nbsp;<span style="text-decoration-style:wavy;color:dimgray;"><b>Headquarters</b></span><br/>
                    Suresh Gyan Vihar University<br/>
                    Jagatpura
                    <br/>
                    <br/>
                    E-Mail Us:<br/>
                    olmusic1@musicwala.com
                    <br/>

                </p>

                <p style="text-align:left;font-family:Arial;font-size: 10pt;font-weight: bold;">
	...
	<div id="templatemo_footer">
        <a href="index.html">Home</a> | <a href="Audio.aspx">Audios</a> | <a href="#">Albums</a><br />
