<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BBD.aspx.cs" Inherits="BBD" %>
    ...
    <a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
        ...
        <div id="templatemo_right_column">
        	<div id="new_released_section">
                <strong style="font-size:40px;font-family:'Comic Sans MS';text-align:center;">Baar Baar Dekho</Strong>
				<p style="text-align:left">
                     <img src="images/bbD.jpg" alt="image" style="width:140px; height:140px" />
				</p>
                <p>
