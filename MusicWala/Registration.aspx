...
<body>
	...
	<div id="templatemo_header">
    	<div id="templatemo_title">
            <div id="templatemo_sitetitle">Music <span>Wala</span></div>
        </div>
	...
	<div id="templatemo_banner">
       	<div id="templatemo_banner_text">
            <div id="banner_title">Welcome To Music Wala</div>
            <p>
    ...
    <div id="templatemo_menu">
     	<ul>
            ...
            <li><a href="Audios.aspx">Audios</a></li>
        	...
        	<div id="new_released_section">
				<table style="text-align:left;"> 
                    <tr>
                        ...
                        <th>
                               <asp:TextBox ID="TxtName" CssClass="txt" radius="20" runat="server" BackColor="#FFFFFF" Font-Bold="True" Font-Italic="True" ForeColor="#003366" ></asp:TextBox>
                            </th>
                        </tr>
                     <tr>
                        <th>
                        ...
                        <th>
                            <asp:TextBox ID="TxtMobile" CssClass="txt" radius="20" runat="server" BackColor="#FFFFFF" Font-Bold="True" Font-Italic="True" ForeColor="#003366"  ></asp:TextBox>
 ...
 <tr>
                        ...
                        <th>
                            <asp:TextBox ID="TxtEmail" CssClass="txt" radius="20" runat="server" BackColor="#FFFFFF" Font-Bold="True" Font-Italic="True" ForeColor="#003366"  ></asp:TextBox>
 ...
 <tr>
                        ...
                        <th>
                            <asp:TextBox ID="TxtPass" CssClass="txt" radius="20" runat="server" BackColor="#FFFFFF" Font-Bold="True" Font-Italic="True" ForeColor="#003366" TextMode="Password" ></asp:TextBox>
 ...
 <tr>
                        ...
                        <th>
                            <asp:TextBox ID="TxtAddress" CssClass="txt" radius="20" runat="server" BackColor="#FFFFFF" Font-Bold="True" Font-Italic="True" ForeColor="#003366"  ></asp:TextBox>

                        </th>
                    </tr>
 <tr>
                        <th>
                        <p class="pp">Favourite</p>
                        </th>
                        <th>
                            <asp:TextBox ID="TxtFav" CssClass="txt" radius="20" runat="server" BackColor="#FFFFFF" Font-Bold="True" Font-Italic="True" ForeColor="#003366"  ></asp:TextBox>
	...
	<div id="templatemo_footer">
        <a href="#">Home</a> | <a href="#">Audios</a> | <a href="#">Albums</a> | <a href="#">Artists</a> | <a href="#">Contact</a><br />
